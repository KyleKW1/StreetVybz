...
def screenshot_shield(viewer: str):
    ...
    st.html(
        ...
        'body.hd-away:has(.hd-shield) section[data-testid="stMain"] { filter:blur(22px) !important; }'
        'section[data-testid="stMain"]:has(.hd-shield) { -webkit-user-select:none; user-select:none; '
        '-webkit-touch-callout:none; }'
        'section[data-testid="stMain"]:has(.hd-shield) :is(input, textarea) { -webkit-user-select:text; user-select:text; }'
